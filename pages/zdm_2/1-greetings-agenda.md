...
developers in building and signing firmware artifacts as well as make those
...
tooling it aims to produce skeleton for OpenBMC autoport. With special focus on
Root of Trust and Chain of Trust of BMC, as all Zarhus OS derivatives.

[click]

ZarhusWRT - the same concept but aim for OpenWRT ecosytem of wireless routers.
With aim of target wireless routers and support provisioning and maintaining
RoT and CoT for those chipsets.
...
Obviously it does no contain other statistics like direct downloads from
boot.3mdeb.com
